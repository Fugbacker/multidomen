      ...
      Promise.all(
        objectList.map(async (it) => {
          ...
          const message = {
            ...
            to: it.email,
            subject: `Скидка 20% на заказ №${it.orderNumber} на сайте nspdm.su`,
            html: `
