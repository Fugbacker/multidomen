...
export default function SearchMapRosegrn ({ cadastrData, setCadastrData, setCadastrNumber, closeChecker, setAlarmMessage, setBaloonData, referer, error, setError }) {
  const tokenList = [
