...
export default function SearchMapGoskadastr ({ cadastrData, setCadastrData, setCadastrNumber, closeChecker, setAlarmMessage, setBaloonData, referer, error, setError, type, setType }) {
  const tokenList = [
            ...
            <form id={style.request_form}>
                ...
                <div className={style.search__example}>Пример:
                  ...
                  <span
                    ...
                    onClick={() => {
                      setDadata('')
                      setValidInput(true)
                      setEnterText('56:12:1101001:902')
                    }}
                  >  56:12:1101001:902
                  </span>
                </div>
              ...
              <div className={style.formData}>
                  <div className={style.formDataText}>
                    <p>
                      Универсальная форма поиска по кадастровому номеру или адресу объекта недвижимости.
                    </p>
                  </div>
                  <button
                    type="button"
