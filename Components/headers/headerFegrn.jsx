...
export default function HeaderFegrn () {
  return (
          ...
          <div className={`${style["flex-ac-jcb"]}`}>
            <a href="/">
              <div className={style["header__logo-info"]}>
                <div className={style["header__logo-title"]}>fegrn.su</div>
            ...
            <div className={`${style["flex-ac"]}`}>
              ...
              <div className={`${style.mail} ${style["h-mylo"]}`} data-item1="fegrn.su" data-item2="e-mail: admin"></div>
